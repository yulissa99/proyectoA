    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            solicitarPermiso(Manifest.permission.ACCESS_FINE_LOCATION, "Sin el permiso" +
                            " no puedo accedera tu ubicacion.",
                    100, this);
        }

        LatLng destino = new LatLng(Double.parseDouble("12.125036"),Double.parseDouble("-86.273017"));
        LatLng origen = new LatLng(Double.parseDouble("12.127365"),Double.parseDouble("-86.269906"));
